    ...
    <>
      ...
      <section className="mx-auto max-w-5xl px-4 lg:px-8 py-10 md:py-16 grid gap-8 md:grid-cols-2 items-center">
        <Reveal x={-40} rotate={-3}>
          <TiltCard className="rounded-2xl overflow-hidden shadow-card max-w-sm">
            <div className="relative group overflow-hidden rounded-2xl">
              <img src={portrait} alt="Abdullah Qureshi" className="w-full h-auto block rounded-2xl group-hover:scale-105 transition-transform duration-700" />
        ...
        <Reveal delay={0.15} x={40}>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-2 bg-brand-yellow text-black bg-amber-400 font-semibold px-5 py-2.5 rounded-full shadow-glow text-sm"
            >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-2 border border-border text-foreground font-semibold px-5 py-2.5 rounded-full hover:text-brand-yellow transition-colors text-sm"
            >
